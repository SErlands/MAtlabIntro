...
legend('total amount', 'video', 'file transfers', 'web and other', 'Location','northwest','Orientation','vertical')
xlabel 'year'
ylabel 'amount of data (PB)'
title 'Datatraffic 2013-2018'
...
legend('total amount', 'video', 'file transfers', 'web and other', 'Location','northwest','Orientation','vertical');
xlabel 'year'
ylabel 'amount of data (GB)'
title 'Average use of data for a swede 2013-2018'
...
subplot(2, 1, 1);
bar(years, traffic)
legend('video', 'file transfers', 'web and other', 'Location','northwest','Orientation','vertical')
xlabel 'year'
ylabel 'amount of data (PB)'
title 'Datatraffic 2013-2018 ("grouped")'
...
xlabel 'year'
ylabel 'amount of data (PB)'
title 'Datatraffic 2013-2018 ("stacked")'